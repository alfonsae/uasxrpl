        ...
        <a class="navbar-brand" href="#"><img style="height: 55px;" src="logo.png" alt=""></a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item" style="font-family: 'Poppins', sans-serif;">
                    <img src="soccerball.png" style="width: 35px; margin-top: 5px; margin-left: 15px;">
                    <a href="index.php"><button style="background-color: #212A3E; border-color: #212A3E; margin-top: 10px; margin-left: 15px;" type="button" class="btn btn-primary btn-sm">LOGOUT</button></a>
                </li>
            </ul>
            </div>
        </div>
